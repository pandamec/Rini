...
ax1_3 = Axis(fig3[1,1],
    ...
    Makie.scatter!(ax1_1,ϵ_exp[1]*100,σ_exp[1]/1e6; markersize=12, label = " Exp $(round(dϵdt[1]*60*100, digits=3)) [%/min]")
    Makie.scatter!(ax1_1,ϵ_exp[1]*100,σ_sim[1]/1e6; markersize=12, label = "Model $(round(dϵdt[1]*60*100, digits=3)) [%/min]")
    axislegend(ax1_1, labelsize=font-10, framevisible=false)

    Makie.scatter!(ax1_2,ϵ_exp[2]*100,σ_exp[2]/1e6; markersize=12, label = " Exp $(round(dϵdt[2]*60*100, digits=3)) [%/min]")
    Makie.scatter!(ax1_2,ϵ_exp[2]*100,σ_sim[2]/1e6; markersize=12, label = "Model $(round(dϵdt[2]*60*100, digits=3)) [%/min]")
    axislegend(ax1_2, labelsize=font-10, framevisible=false)

    Makie.scatter!(ax1_3,ϵ_exp[3]*100,σ_exp[3]/1e6; markersize=12, label = " Exp $(round(dϵdt[3]*60*100, digits=3)) [%/min]")
    Makie.scatter!(ax1_3,ϵ_exp[3]*100,σ_sim[3]/1e6; markersize=12, label = "Model $(round(dϵdt[3]*60*100, digits=3)) [%/min]")
    axislegend(ax1_3, labelsize=font-10, framevisible=false)
